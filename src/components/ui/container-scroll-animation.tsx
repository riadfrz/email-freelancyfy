...
export const ContainerScroll = ({
    ...
    return (
        ...
        >
            <div
                className="relative w-full py-0 md:py-10"
                style={{
                    perspective: '1000px',
                }}
            >
...
export const Card = ({
    ...
    return (
        <motion.div
            ...
            className="mx-auto mt-8 hidden w-full max-w-[1200px] rounded-[30px] border-4 border-[#6C6C6C] bg-[#222222] p-2 shadow-2xl md:block md:aspect-[16/10] md:p-6"
        >
